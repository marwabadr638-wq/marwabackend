...
VALUES 
(1, 'Tri-Therapy Bundle <br><small class="arabic-text medium">(باقة العلاج الثلاثي)</small>', 349.99, 425.00, 'Save 18%', 'images/course-tri-therapy.png', true, '15 Days', 'Complete mastery of evidence-based therapies. Includes full access to DBT, CBT, and ACT courses.'),
